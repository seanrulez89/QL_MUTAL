...
public class MyBotModule extends DefaultBWListener {
    ...
    public void onFrame() {
        ...
        // 타임아웃 체크 메모리 부족시 증설
        if (timeStartedAtFrame.length < Broodwar.getFrameCount() + 10) {
    ...
    public void checkGameLostConditionAndLeaveGame() {
        ...
        if (canDoSomeThingNonBuildingUnitCount == 0 && canProduceBuildingCount == 0 && canAttackBuildingCount == 0 && !isGameLostConditionSatisfied) {
