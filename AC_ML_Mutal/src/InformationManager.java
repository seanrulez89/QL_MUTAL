...
public class InformationManager {
    ...
    public InformationManager() {
        ...
        mainBaseLocationChanged.put(selfPlayer, true);
        ...
        mainBaseLocationChanged.put(enemyPlayer, false);
    ...
    public void updateChokePointAndExpansionLocation() {
        if (mainBaseLocationChanged.get(selfPlayer)) {
            if (mainBaseLocations.get(selfPlayer) != null) {
            ...
            mainBaseLocationChanged.put(selfPlayer, false);
        }

        if (mainBaseLocationChanged.get(enemyPlayer)) {
            if (mainBaseLocations.get(enemyPlayer) != null) {
