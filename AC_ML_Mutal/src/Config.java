...
public class Config {
    ...
    // 봇 이름
    public static final String BotName = "fast-mutalisk";
    // 봇 개발자 이름
    public static final String BotAuthors = "Junhong Park";
    ...
    // 각각의 Refinery 마다 투입할 일꾼 최대 숫자
    public static int WorkerPerRefineryCompleteUpgrade = 1;
